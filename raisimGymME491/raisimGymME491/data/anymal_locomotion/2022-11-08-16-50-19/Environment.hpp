...
class ENVIRONMENT : public RaisimGymEnv {
 ...
 public:
  ...
  explicit ENVIRONMENT(const std::string& resourceDir, const Yaml::Node& cfg, bool visualizable) :
    ...
    footIndices_.insert(aliengo_->getBodyIdx("LF_SHANK"));
    footIndices_.insert(aliengo_->getBodyIdx("RF_SHANK"));
    footIndices_.insert(aliengo_->getBodyIdx("LH_SHANK"));
    footIndices_.insert(aliengo_->getBodyIdx("RH_SHANK"));
